...
for i in range(len(Best_schedule)):
    if len(Best_schedule[i])==2:
        Best_schedule[i] = f"J_{Best_schedule[i]}"
print(Best_schedule)

#%% Best schedule found during tests

Best_found_schedule = ['J_51', 'J_61', 'J_21', 'J_11', 'J_41', 'J_31', 'J_22', 'J_12', 'J_71', 'J_32', 'J_13', 'J_23', 'J_42', 'J_14', 'J_24', 'J_15', 'J_33', 'J_52', 'J_25', 'J_62', 'J_16', 'J_43', 'J_26', 'J_17', 'J_44', 'J_34', 'J_27', 'J_18', 'J_28']
Minimum_found_waiting_time = 162
